...
import { leadStatusLabels, recommendedActionLabels } from "@/config/product";
...
export interface LeadDetailPanelProps {
  leadId: string;
  /** `split` : rendu compact en une colonne dans l'inbox. */
  variant?: "page" | "split";
  className?: string;
}

export function LeadDetailPanel({ leadId, variant = "page", className }: LeadDetailPanelProps) {
