...
function DemoHubPage() {
  ...
  return (
    <div className="min-h-screen bg-paper">
      <SiteHeader />
      <main className="mx-auto max-w-[1440px] px-5 py-14 lg:px-10 lg:py-20">
        ...
        <div
          ...
          className="mt-10 inline-flex rounded-xl border border-border bg-surface p-1"
        >
          {(
            [
            ...
            <button
              ...
              className={cn(
                "min-h-11 rounded-lg px-4 text-sm transition-colors",
                side === value
